...
const CalendarScreen = () => {
  ...
  const theme = {
    ...
    textDayFontWeight: '300' as '100' | '200' | '300' | '400' | '500' | '600' | 'bold' | '700' | '800' | '900', // Ensure valid font weight
    textMonthFontWeight: 'bold' as '100' | '200' | '300' | '400' | '500' | '600' | 'bold' | '700' | '800' | '900', // Ensure valid font weight
    textDayHeaderFontWeight: '300' as '100' | '200' | '300' | '400' | '500' | '600' | 'bold' | '700' | '800' | '900', // Ensure valid font weight
    textDayFontSize: 16,
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={styles.container}>
        <CalendarList
          ...
          markingType={'period'}
          markedDates={{
            [formatDate(today)]: { selected: true, marked: true, dotColor: 'blue' },
          }}
